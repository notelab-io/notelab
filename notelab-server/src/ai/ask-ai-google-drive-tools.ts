...
} from "../../../notelab-client/src/connectors/google-drive/src/index.js";
import { tool, type ToolSet } from "ai";
import * as z from "zod";

import { truncateText } from "./ask-ai-utils";

const googleWorkspaceExportMimeTypes: Record<string, string> = {
...
async function readDriveText(
  ...
  if (mimeType && googleWorkspaceExportMimeTypes[mimeType]) {
    return drive.exportFile(file.id, googleWorkspaceExportMimeTypes[mimeType]);
  }
