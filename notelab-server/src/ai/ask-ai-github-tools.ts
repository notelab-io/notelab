import {
  ...
  type GithubUser,
} from "../../../notelab-client/src/connectors/github/src/index.js";
...
export function buildGithubTools(accessToken: string): ToolSet {
  ...
  return {
    getGithubProfile: tool({
      description:
        "Read the connected GitHub user profile for the organization integration.",
    ...
    listGithubRepositories: tool({
      ...
      inputSchema: z.object({
        affiliation: z.string().trim().default("owner,collaborator,organization_member"),
