...
export const GOOGLE_CALENDAR_GOOGLE_OAUTH_AUTH_URL =
  "https://accounts.google.com/o/oauth2/v2/auth";

export const GOOGLE_CALENDAR_GOOGLE_OAUTH_TOKEN_URL =
...
export const GOOGLE_CALENDAR_GOOGLE_IDENTITY_SCOPES = [
  "openid",
  "email",
  "profile",
] as const;
...
export const GOOGLE_CALENDAR_CONNECTOR_SCOPES = [
  ...GOOGLE_CALENDAR_GOOGLE_IDENTITY_SCOPES,
