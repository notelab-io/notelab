...
import {
  buildWorkspaceEditDiffSegments,
  hasWorkspaceEditDiffChanges,
} from "@/components/ai-elements/workspace-edit-diff"
import { cn } from "@/lib/utils"

export function WorkspaceEditDiffPanel({
  afterMarkdown,
  beforeMarkdown,
  className,
}: {
  ...
  const segments = buildWorkspaceEditDiffSegments(
    beforeMarkdown,
    afterMarkdown,
  )
  const hasChanges = hasWorkspaceEditDiffChanges(segments)
