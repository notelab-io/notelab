    ...
    <div className="space-y-4">
      <div className="rounded-lg border bg-card p-4 text-card-foreground shadow-xs">
            ...
            <div className="min-w-0 space-y-2">
              <div className="space-y-1">
                <div className="flex flex-wrap items-center gap-2">
                  <h4 className="font-medium">Google Drive workspace</h4>
        ...
        {!isWorkspaceConnected && !canManageWorkspace ? (
          <Alert className="mt-4">
            <AlertDescription>
              Google Drive workspace is not connected. Ask an admin to connect
              it before linking your Drive account.
            </AlertDescription>
          </Alert>
        ) : null}
        {status?.configured === false ? (
      ...
      <div className="rounded-lg border bg-card p-4 text-card-foreground shadow-xs">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="flex min-w-0 gap-3">
            ...
            <div className="min-w-0 space-y-2">
              <div className="space-y-1">
                <div className="flex flex-wrap items-center gap-2">
                  <h4 className="font-medium">My Google Drive account</h4>
                  <ConnectionBadge connected={status?.personal.connected} />
                </div>
                <p className="max-w-xl text-sm text-muted-foreground">
                  Connect your Drive identity so AI can read files visible to
                  your Google account.
                </p>
              </div>
              <div className="grid gap-2 text-sm md:grid-cols-2">
        ...
        {!isWorkspaceConnected ? (
          <Alert className="mt-4">
            <AlertDescription>
              Google Drive workspace is not connected yet.
            </AlertDescription>
          </Alert>
        ) : null}
      </div>
