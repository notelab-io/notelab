...
export function getCallbackUrl(
  ...
  return `${url.origin}/api/workspace/settings/integrations/${integration}/callback`;
}

export function signState(c: WorkspaceSettingsContext, payload: OAuthState) {
...
function getStateSecret(c: WorkspaceSettingsContext) {
