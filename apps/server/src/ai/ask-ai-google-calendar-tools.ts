...
} from "@notelab/connectors/google-calendar";
    ...
    ...(coworkerCalendarAccessEnabled
      ? {
          queryGoogleCalendarFreeBusy: tool({
            description:
              "Check free/busy availability for coworkers or calendar ids in the workspace. This returns busy blocks, not private event details.",
            inputSchema: z.object({
              calendarIds: z
