/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 807242542737d1956b035da4fc515e45)
// Runtime types generated with workerd@1.20260521.1 2026-05-28 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	IMAGE_BUCKET: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	BETTER_AUTH_URL: "https://api.notelab.io";
	CLIENT_URL: "https://app.notelab.io";
	EMAIL_FROM: "Notelab <hello@notelab.io>";
	...
	CHAT_AGENT: DurableObjectNamespace<import("./src/worker").ChatAgent>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "CLIENT_URL" | "EMAIL_FROM" | "IMAGE_READ_URL_TTL_SECONDS" | "IMAGE_UPLOAD_MAX_BYTES" | "IMAGE_UPLOAD_URL_TTL_SECONDS" | "R2_BUCKET_NAME">> {}
}
...
interface IncomingRequestCfPropertiesBase extends Record<string, unknown> {
    ...
    asn?: number;
    /**
     * The workspace which owns the ASN of the incoming request.
     *
